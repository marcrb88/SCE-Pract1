!function(root, factory) {
    ...
    return function(modules) {
        ...
        function lib_global_getGlobal(win) {
            ...
            win.__zoid_10_0_1__ || (win.__zoid_10_0_1__ = {});
            return win.__zoid_10_0_1__;
        }
            ...
            var registerChild = memoize((function() {
                if (isChild()) {
                    ...
                    var child = function(options) {
                        ...
                        if ("10_0_1" !== version) throw new Error("Parent window has zoid version " + version + ", child window has version 10_0_1");
